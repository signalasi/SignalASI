...
| Voice page | Local wake mode, ASR provider selection, PC STT routing, TTS settings, and reply preservation are available from the app. | `npm run smoke:android:ui`, `npm run smoke:android:voice-reply`, `npm run smoke:desktop:voice-stt` |
