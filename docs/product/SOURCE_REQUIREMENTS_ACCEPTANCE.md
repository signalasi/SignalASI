...
| CP-15 | Background orchestration and user-visible Agent teams | durable `AgentTeamExecutionRuntime`, production connector bridge, single-responder policy, observer failure isolation, and Recent Tasks expansion gate | Partial | Real paired-team dispatch, forced process death, and durable late-response correlation |
