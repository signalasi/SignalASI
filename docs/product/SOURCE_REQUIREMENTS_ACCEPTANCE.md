...
| PA-18 | Personal ASI can use native tools, Skills, MCP, specialist Agents, local/cloud models, Desktop, and smart-home resources | host registries, `AgentProductionTeamController`, supervised specialist contracts, and production connector team bridge | Partial | One real-device verified scenario per resource class and paired multi-Agent synthesis |
